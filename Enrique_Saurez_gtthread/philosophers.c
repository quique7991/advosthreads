...
*/
#define PHILOSOPHER_NUM 5 /*Number of philosophers in the table*/
#define MAX_RANDOM_LOOP 99999999 /*Max number of iterations in the spin while eating or thinking*/
#define INIT_TIME 1000 /*Time used to init the timer of the library*/
#include <stdio.h>
#include <time.h>
#include "gtthread.h"
...
void* dinner_philospher(void* arg){
	...
	while(1){
		...
		random_number = (rand() % MAX_RANDOM_LOOP);
